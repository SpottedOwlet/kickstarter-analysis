...
* The data under consideration was verified for absence of null or blank values.
...
* Next, only the years were extracted from the 'Date Created Conversion' column into a separate column 'Years' using YEAR() function in Excel. The 'Years' column     was later used for filtering Pivot table based on year of the launch date.
...
<img width="437" alt="Pivot_Table_Outcomes_by_Launch_Date" src="https://user-images.githubusercontent.com/90424752/138800245-5673745f-a833-430b-9ebf-0c8c7cd7ab63.png">
 ...
 <h3> <p align=center> Visualization : Theater Outcomes by Launch Date  </p> </h3>
...
* The graph shows that the highest number of successful campaigns were launched in the month of May (111), followed by June (100).
* December has lowest number of successful outcomes (37) and are almost equal in number to failed outcomes (35).
...
<h3> <p align=center>  Visualization : Outcomes Based on Goals </p> </h3>
...
* The second analysis was based on single parameter - percentage. The percentages can be ambiguous and misleading as they do not take into account the actual number of the data points. 
...
* To make the above analysis more thorough, a few additional analyses could be performed:

  * **Theater Outcomes by Launch Date:**
    1. The above analysis with additional data that is also more recent ( during years 2018 to 2021) could either bolster the findings from the line chart or could        lead to slight change in the observed trends.
